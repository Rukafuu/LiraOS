            ...
            {mode !== 'forgot' && (
             <div className="pt-3">
              ...
              <div className="flex gap-2">
                <a href={oauth.google} className="flex-1 px-3 py-2.5 bg-white/10 hover:bg-white/20 rounded-lg border border-white/10 text-white text-sm text-center transition-colors">
